...
def edit_doc_contents(
    ...
    old_string: str = Field(description="The text to be replaced. Must match exactly including whitespace."),
...
def format_document(  
    ...
    prompt = f'''
    Your goal is to reformat documents into Markdown format.
    The id of the document you need to reformat is:
    <document_id>
    {doc_id}
    </document_id>

    Add in headers, bullet points, tables, etc as necessary. Feel free to add in structure, and clear implementation phases, headings, and bullet points.
